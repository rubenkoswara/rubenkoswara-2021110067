            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Posisi Jabatan -->
                        <div class="row mb-3">
                            <label for="posisi_jabatan" class="col-md-4 col-form-label text-md-end">Posisi Jabatan</label>
                            <div class="col-md-6">
                                <input id="posisi_jabatan" type="text" class="form-control @error('posisi_jabatan') is-invalid @enderror" name="posisi_jabatan" value="{{ old('posisi_jabatan') }}">
